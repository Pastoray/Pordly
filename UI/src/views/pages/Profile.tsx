...
import { activate_booster, change_bio, change_credentials, delete_access_token, delete_account, fetch_user_boosters, format_date, get_user, validate_form } from "../../utils/Index"
...
function Profile() {
    ...
    useEffect(() => {
        async function get_boosters() {
            const boosters = await fetch_user_boosters()
